...
export interface WinnerPredictionPoolInterface extends utils.Interface {
  contractName: "WinnerPredictionPool";
  functions: {
...
export interface WinnerPredictionPool extends BaseContract {
  contractName: "WinnerPredictionPool";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WinnerPredictionPoolInterface;
